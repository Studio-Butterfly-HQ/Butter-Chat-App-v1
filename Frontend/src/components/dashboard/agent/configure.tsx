...
export const Configure = () => {
  ...
  const [aiFallbackCustom, setAiFallbackCustom] = useState(
  ...
  const [humanTransferMessage, setHumanTransferMessage] = useState(
    "I am connecting you to a human agent.",
  );
      ...
      >
        ...
        >
          ...
          <AccordionContent className="border-t border-border p-4 space-y-4">
            ...
            <Select
              value={aiFallback}
              onValueChange={(v) => setAiFallback(String(v))}
            >
            ...
            <div className="flex items-center gap-4">
              <Switch
                checked={aiFallbackWait}
                onCheckedChange={(v) => setAiFallbackWait(!!v)}
              />
